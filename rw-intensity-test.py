...
for bs in block_sizes:
    output_file = f"rw-intensity-results/rw_intensity_{bs}.json"  # Customize output file name per block size
    print(f"Running test with block size {bs}, saving to {output_file}")
    subprocess.run([
        "fio",
        "my-fio-tests/rw-intensity-test.fio",  # Load parameters from your .fio file
